...
import { PadesProvider } from "./signature/pades";
import { GmSm2Provider } from "./signature/gm-sm2";
...
export function registerStage2Signature(method: "PADES" | "GM_SM2"): void {
  if (method === "PADES") {
    registerSignatureProvider("PADES", new PadesProvider());
  } else {
    registerSignatureProvider("GM_SM2", new GmSm2Provider());
  }
}
