...
export const TEMPLATE_STATUS_VARIANTS: Record<TemplateVersionStatus, "default" | "secondary" | "destructive" | "outline"> = {
  DRAFT: "secondary",
  PUBLISHED: "default",
  ARCHIVED: "outline",
};
...
export const APPROVAL_STATUS_VARIANTS: Record<ApprovalStatus, "default" | "secondary" | "destructive" | "outline"> = {
  DRAFT: "secondary",
  PENDING: "default",
  APPROVED: "default",
...
export const SIGNING_STATUS_VARIANTS: Record<SigningStatus, "default" | "secondary" | "destructive" | "outline"> = {
  NOT_STARTED: "default",
  IN_PROGRESS: "default",
  COMPLETED: "secondary",
