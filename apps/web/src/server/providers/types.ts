...
export interface SignatureProvider {
  sign(input: {
    ...
    /**
     * Pre-claimed next version number (avoids concurrent signers both writing
     * source.version + 1). Callers must claim under a document row lock.
     */
 ...
 *
 * Email (SMTP) is mandatory in Phase 1; WeCom/DingTalk/Lark/Slack/Teams are optional
