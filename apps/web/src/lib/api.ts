...
export const ERROR_CODES = [
  ...
  // Envelopes (DocuSign-parity)
  "ENVELOPE_NOT_FOUND",
  "ENVELOPE_INVALID_STATE",
  "ENVELOPE_NO_RECIPIENTS",
  "ENVELOPE_NO_DOCUMENTS",
  "ENVELOPE_NOT_COMPLETED",
  "RECIPIENT_NOT_FOUND",
  "RECIPIENT_ALREADY_SIGNED",
  "RECIPIENT_CC_NO_SIGN",
  "ENVELOPE_SUBJECT_REQUIRED",
  "POWERFORM_NOT_FOUND",
  "NO_ACTOR_USER",
  "SIGN_LINK_MISSING",
  "IDV_REQUIRED",
  "IDV_METHOD_INVALID",
  "IDV_METHOD_NOT_IMPLEMENTED",
  "PHONE_REQUIRED",
  "SMS_OTP_COOLDOWN",
  "CLICKWRAP_NOT_FOUND",
  "ROOM_NOT_FOUND",
  "CLM_AGREEMENT_NOT_FOUND",
  "NOTARY_TX_NOT_FOUND",
  "ACCOUNT_NOT_FOUND",
